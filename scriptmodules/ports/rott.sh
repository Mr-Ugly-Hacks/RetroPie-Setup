...
function configure_rott() {
    ...
    addPort "$md_id" "rott" "rott - Rise of the Triad port" "XINIT:$md_inst/bin/rott"
    addPort "$md_id" "rott-shareware" "rott - Rise of the Triad port Shareware" "XINIT:$md_inst/bin/rott-shareware"
	else 
