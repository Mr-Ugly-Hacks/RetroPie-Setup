...
done < /home/pi/RetroPie-Setup/scriptmodules/supplementary/escollections/escollections/${filename}

cat /tmp/tempfile.cfg |sort -u > /tmp/custom-${choice}.cfg
cp /tmp/custom-${choice}.cfg /opt/retropieconfigs/all/emulationstation/collections
rm /tmp/tempfile.cfg
