...
function configure_lr-gambatte() {
	...
	addEmulator 1 "$md_id" "gb-jp" "$md_inst/gambatte_libretro.so"
    addEmulator 1 "$md_id" "gbc-jp" "$md_inst/gambatte_libretro.so"
	addEmulator 1 "$md_id" "gbh" "$md_inst/gambatte_libretro.so"
    addEmulator 1 "$md_id" "gb-unl" "$md_inst/gambatte_libretro.so"
    addSystem "gb"
    addSystem "gbc"
	addSystem "gb-jp"
    addSystem "gbc-jp"
