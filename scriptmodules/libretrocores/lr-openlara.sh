...
rp_module_repo="git https://github.com/libretro/OpenLara.git"
...
if [ "\$ROMS" == "" ]; then
    ...
    joy2keyStop
    item=\$((\$ROMS*2-1)) 
    "/opt/ares/supplementary/runcommand/runcommand.sh" 0 _PORT_ "tombraider" "$romdir/ports/tombraider/level/$dir/\${W[\$item]}"
fi
_EOF_
